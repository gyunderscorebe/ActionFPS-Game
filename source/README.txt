...
The ActionFPS source code is mainly based on the cube game/engine and uses the 
same license (z-lib like). See README_CUBEENGINE.txt
In addition ActionFPS contains code from pCube (Cube pro mod) and Sauerbraten (Cube successor)
and other sources.
...
The cheat protection described in README_CUBEENGINE.txt is not used in ActionFPS. Binaries 
compiled from source are compatible with the official binaries. This means, the client can 
easily be hacked, on the other hand, you can compile ActionFPS for different platforms and 
fix bugs yourself.
